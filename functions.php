...
$submenu['edit.php'][16][0] = 'Nyhetstaggar';
echo '';
}
...
$labels->new_item = 'Nyheter';
$labels->view_item = 'Visa Nyheter';
...
function tf_functions_css() {
	wp_enqueue_style('tf-functions-css', get_stylesheet_directory_uri() . '/css/tf-functions.css');
}
...
$args = array(
    ...
    'menu_icon' => get_stylesheet_directory_uri().'/images/event_16.png',
    'hierarchical' => false,
...
function events_scripts() {
    ...
    wp_enqueue_script('ui-datepicker', get_stylesheet_directory_uri() . '/js/jquery.ui.datepicker.js', array('jquery'));
